      ...
      <?php else: ?>
        ...
        <div class="mt-4">
                <?php if($medida->deletado_em == null): ?>
                  ...
                  <a href="<?php echo base_url("admin/medidas/editar/$medida->id"); ?>" class="btn btn-dark btn-sm mr-2">
                    <i class="mdi mdi-pencil btn-icon-prepend"></i>
                  Editar
              </a>
              <a href="<?php echo base_url("admin/medidas/excluir/$medida->id"); ?>" class="btn btn-danger btn-sm mr-2">
          ...
          Voltar
              ...
              <?php else: ?>
                <a href="<?php echo base_url("admin/medidas/desfazerexclusao/$medida->id"); ?>" class="btn btn-dark btn-sm">
                <i class="mdi mdi-undo btn-icon-prepend mr-2"></i>Desfazer</a>
                <a href="<?php echo base_url("admin/medida"); ?>" class="btn btn-light text-dark btn-sm">
                  <i class="mdi mdi-arrow-left btn-icon-prepend"></i>
                Voltar
              </a>
