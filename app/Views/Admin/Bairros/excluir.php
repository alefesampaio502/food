  ...
  <div class="card">
    ...
    <div class="card-body">
      ...
      <div class="alert alert-warning alert-dismissible fade show" role="alert">
          <strong>Atenção: </strong> Tem certeza que deseja excluir a bairro
          <strong><?php echo esc($bairro->nome);?>
          ?.</strong>
      </div>
      <button type="submit" class="btn btn-danger mr-2 btn-sm">
        <i class=" mdi mdi-trash-can btn-icon-prepend mr-1"></i>excluir
      </button>
        <a href="<?php echo base_url("admin/bairros/show/$bairro->id"); ?>" class="btn btn-light text-dark btn-sm">
