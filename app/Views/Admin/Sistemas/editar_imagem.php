...
<div class="col-lg-10 grid-margin stretch-card">
  <div class="card">
    ...
    <div class="card-body">
      ...
      <?php echo form_open_multipart("admin/sistemas/upload/$sistema->id"); ?>

      <div class="form-group mb-4">
                      <label>Upload de imagem</label>
                      <input type="file" name="foto_sistema" class="file-upload-default">
      ...
      <button type="submit" class="btn btn-primary mr-2 btn-sm"><i class=" mdi mdi mdi-file-image btn-icon-prepend mr-1"></i>Salvar
        ...
        <a href="<?php echo base_url("admin/sistemas/show/$sistema->id"); ?>" class="btn btn-light text-dark btn-sm">
