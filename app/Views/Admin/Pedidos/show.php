  ...
  <div class="col-lg-6 grid-margin stretch-card">
    <div class="card">
      ...
      <div class="card-body">
        ...
        <?php $pedido->exibeSituacaoPedido();?>
        </p>
        <p class="card-text">
        ...
        <p class="card-text">
          <span class="font-weight-bold">Valor dos produtos:</span>
            R$&nbsp<?php echo esc(number_format($pedido->valor_produtos, 2));?>
        </p>
        <p class="card-text">
          <span class="font-weight-bold">Valor de entrega:</span>
            R$&nbsp<?php echo esc(number_format($pedido->valor_entrega, 2));?>
        </p>
        <p class="card-text">
        ...
        <p class="card-text">
          <span class="font-weight-bold">Observações:</span>
            R$&nbsp<?php echo esc($pedido->observacoes);?>
        </p>
      ...
      <?php endif; ?>
        ...
        <ul class="list-group">
          ...
          <li class="list-group-item">
            <p><b>Produto:</b> <?php echo $produto['nome']; ?></p>
            <p><b>Quantidade:</b> <?php echo $produto['quantidade']; ?></p>
            <p><b>Preço:</b> R$&nbsp<?php echo  number_format($produto['preco'], 2); ?></p>
          </li>
        <?php endforeach; ?>
        </ul>
        <div class="mt-4">

                <a href="<?php echo base_url("admin/pedidos/editar/$pedido->codigo"); ?>" class="btn btn-dark btn-sm mr-2">
                <i class="mdi mdi-pencil btn-icon-prepend"></i>
                Alterar situação
                </a>
                <a href="<?php echo base_url("admin/pedidos/excluir/$pedido->codigo"); ?>" class="btn btn-danger btn-sm mr-2">
                <i class="mdi mdi-trash-can btn-icon-prepend"></i>
                Excluir pedido
                </a>
                <a href="<?php echo base_url("admin/pedidos"); ?>" class="btn btn-light text-dark btn-sm">
