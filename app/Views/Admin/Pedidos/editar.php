    ...
    <div class="card-body">
      ...
      <div class="form-check form-check-flat form-check-primary mb-4">
        ...
        <label for="saiu_entrega" class="form-check-label">
          ...
          Saiu para entrega</label>
      </div>

      <div id="box_entregador" class="form-group d-none">

         <select name="entregador_id" id="entregador_id" class="form-control text-dark" >
           <option value="">Escolha um entregador...</option>
              <?php foreach ($entregadores as $entregador): ?>

                  <option value="<?php echo esc($entregador->id); ?>" <?php echo ($entregador->id == $pedido->entregador_id ? 'selected' : ''); ?> ><?php echo esc($entregador->nome); ?></option>
      ...
      <div class="form-check form-check-flat form-check-primary mb-4">
        ...
        <label  class="form-check-label">
          ...
          Pedido cancelado</label>
      </div>


        <input id="btn-editar-pedido" type="submit" class="btn btn-success" value="Editar pedido">
        <a href="<?php echo base_url("admin/pedidos/show/$pedido->codigo"); ?>" class="btn btn-light text-dark btn-sm">
