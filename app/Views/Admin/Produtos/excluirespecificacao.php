...
<div class="col-lg-6 grid-margin stretch-card">
  ...
  <div class="alert alert-warning alert-dismissible fade show" role="alert">
          <strong>Atenção: </strong> Tem certeza que deseja Exclusão da especificacão do produto?

      </div>
      <button type="submit" class="btn btn-danger mr-2 btn-sm">
        <i class=" mdi mdi-trash-can btn-icon-prepend mr-1"></i>excluir
      </button>
        <a href="<?php echo base_url("admin/produtos/show/$especificacao->produto_id"); ?>" class="btn btn-light text-dark btn-sm">
