...
<div class="col-lg-12 grid-margin stretch-card">
  <div class="card">
    ...
    <div class="col-lg-6">
      <a href="<?php echo base_url("admin/categorias/criar/"); ?>" class="btn btn-info float-right mb-3 sm">
      ...
      <div class="ui-widget">
          <input type="text" id="query" name="query" class="form-control bg-light mb-5"  placeholder="Pesquisa por uma categoria">
        </div>
      ...
      <div class="table-responsive">
        <table class="table table-hover">
          ...
          <?php foreach ($categorias as $categoria): ?>
            <tr>
            <td>
  <a href="<?php echo base_url("admin/categorias/show/$categoria->id");?>"><?php echo $categoria->nome;?>
              </a>
            </td>
            ...
            <td><?php echo ($categoria->deletado_em == null ? '<label class="badge badge-primary">Disponível</label>' : '<label class="badge badge-danger">Excluindo</label>' ) ?>
                <?php if($categoria->deletado_em != null):?>
                  <a href="<?php echo base_url("admin/categorias/desfazerexclusao/$categoria->id"); ?>" class="badge badge-dark ml-2">
