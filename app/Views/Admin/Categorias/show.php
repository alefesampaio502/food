      ...
      <?php else: ?>
        ...
        <div class="mt-4">
                <?php if($categoria->deletado_em == null): ?>
                  ...
                  <a href="<?php echo base_url("admin/categorias/editar/$categoria->id"); ?>" class="btn btn-dark btn-sm mr-2">
                    <i class="mdi mdi-pencil btn-icon-prepend"></i>
                  Editar
              </a>
              <a href="<?php echo base_url("admin/categorias/excluir/$categoria->id"); ?>" class="btn btn-danger btn-sm mr-2">
                <i class="mdi mdi-trash-can btn-icon-prepend"></i>
              Excluir
          </a>
          <a href="<?php echo base_url("admin/categorias"); ?>" class="btn btn-light text-dark btn-sm">
            <i class="mdi mdi-arrow-left btn-icon-prepend"></i>
          Voltar
        </a>
              <?php else: ?>
                <a href="<?php echo base_url("admin/categorias/desfazerexclusao/$categoria->id"); ?>" class="btn btn-dark btn-sm">
