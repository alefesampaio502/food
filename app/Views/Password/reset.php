        ...
        <div class="auth-form-light text-left py-5 px-4 px-sm-5">
          ...
          <?php echo form_open("password/processareset/$token"); ?>
                <div class="form-group">
                  <label for="senha"> Nova senha: <span class="text-danger">*</span> </label>
            ...
            <input type="submit" class="btn  btn-primary btn-lg font-weight-medium auth-form-btn" value="Redefinir senha"></input>
            </div>
          <?php echo form_close(); ?>
      </div>
    </div>
