...
class Produto extends Entity
{
	...
	public function combinaExtrasDosProdutos(array $extrasPrimeiroProduto, array $extrasSegundoProduto){
		...
		$extrasCombinados = array_merge($extrasPrimeiroProduto, $extrasPrimeiroProduto);

      foreach ($extrasCombinados as $extra) {

					$extraExistente = (bool) in_array($extra->id, array_column($extrasUnicos, 'id'));

					if($extraExistente == false){
