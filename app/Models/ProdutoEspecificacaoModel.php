...
class ProdutoEspecificacaoModel extends Model
{
	...
	//Validações
		...
		protected $validationMessages = [
		 ...
		 'medida_id'        => [
				'required' => 'O campo Medida e obrigatório',
					],
			];

		// Descrição : reretorna as especificações do prodproduto em questão.
		// uso : Admin/Produto/especificações($id = null).
		// int produto_id
		// int $quantidade_paginacao
		//$array objeto);

 public function buscarEspecificacoesDoProduto(int $produto_id, int $quantidade_paginacao){
	 ...
	 public function buscaEspecificacoesDoProdutoDetalhes(int $produto_id = null) {
