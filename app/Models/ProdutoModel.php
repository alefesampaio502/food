...
class ProdutoModel extends Model
{
	...
	protected $validationRules = [
				...
				'ingredientes' => 'required|min_length[5]|max_length[1000]',
		];
...
//uso do Controllers do métdo pprocurar  traves do auto complete///
	// procurar categoria no para request usar
...
//Araray de objetos para para para uso no controller / customizavel
